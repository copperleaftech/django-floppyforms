...
class PasswordInput(TextInput):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        if not self.render_value:
            value = None
        return super(PasswordInput, self).render(name, value, attrs, renderer)
...
class FileInput(Input):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        if self.omit_value:
            ...
            value = None
        return super(FileInput, self).render(name, value, attrs, renderer)
...
class SelectMultiple(Select):
    ...
    def _format_value(self, value):
        if len(value) == 1 and min(value) is None:
            value = []
